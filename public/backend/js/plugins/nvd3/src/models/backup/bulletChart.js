  ...
  function chart(selection) {
    selection.each(function(d, i) {
      ...
      */
      ...
      // Transition the entering ticks to the news scale, x1.
      d3.transition(tickEnter)
          .attr('transform', function(d) { return 'translate(' + x1(d) + ',0)' })
          .style('opacity', 1);

      // Transition the updating ticks to the news scale, x1.
      ...
      // Transition the exiting ticks to the news scale, x1.
