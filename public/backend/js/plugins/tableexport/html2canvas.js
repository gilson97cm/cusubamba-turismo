...
_html2canvas.Parse = function (images, options, cb) {
  ...
  function setZ(element, stack, parentStack){
    ...
    // When a news stacking context should be created:
    // the root element (HTML),
    // positioned (absolutely or relatively) with a z-index value other than "auto",
    // elements with an opacity value less than 1. (See the specification for opacity),
    // on mobile WebKit and Chrome 22+, position: fixed always creates a news stacking context, even when z-index is "auto" (See this post)
  ...
  function renderElement(element, parentStack, ignoreBackground) {
    ...
    switch(element.nodeName){
      case "IMG":
        ...
        break;
      case "INPUT":
        // TODO add all relevant type's, i.e. HTML5 news stuff
