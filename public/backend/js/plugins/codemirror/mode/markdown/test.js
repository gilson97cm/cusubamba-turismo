...
(function() {
  ...
  MT("trailingSpace2",
     "foo[trailing-space-a  ][trailing-space-news-line  ]");

  MT("trailingSpace3",
     "foo[trailing-space-a  ][trailing-space-b  ][trailing-space-news-line  ]");

  MT("trailingSpace4",
     "foo[trailing-space-a  ][trailing-space-b  ][trailing-space-a  ][trailing-space-news-line  ]");
