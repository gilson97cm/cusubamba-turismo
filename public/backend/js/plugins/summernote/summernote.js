...
(function (factory) {
  ...
  var dom = (function () {
    ...
    /**
     * returns news array of ancestor nodes (until predicate hit).
     *
     * @param {Node} node
    ...
    lang: {
      'en-US': {
        ...
        link: {
          ...
          openInNewWindow: 'Open in news window'
        },
        video: {
          video: 'Video',
  ...
  var Editor = function () {
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      // Create a news link when there is no anchor on range.
