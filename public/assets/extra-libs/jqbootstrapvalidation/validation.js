...
(function ($) {
    ...
    var defaults = {
        options: {
            ...
            preventSubmit: true, // stop the form submit events from firing if validation fails
            submitError: false, // function called if there is an error when trying to submit
            submitSuccess: false, // function called just before a successful submit events is sent to the server
