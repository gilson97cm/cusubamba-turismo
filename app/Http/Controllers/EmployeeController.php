...
class EmployeeController extends Controller
{
    public function index(){
        ...
        ->paginate(10);
      // dd($user_deal);
        return view('backend.admin.employees.index', compact('people'));
    }
    public function inactive(){
        $people = Person::join('users','people.id_card_person', '=', 'users.person_id_card')
            ...
            ->paginate(10);
        // dd($user_deal);
        return view('backend.admin.employees.inactive', compact('people'));
    }
    ...
    public function store(EmployeeStoreRequest $request){
        ...
        $user = User::create([
            'person_id_card' => $request['id_card_person'],
            'email' => $request['email'],
    ...
    public function edit($id_employee)
    {
       ...
       // dd($employee->id_card_person);
        $user = User::where('person_id_card',$employee->id_card_person);
        $roles = DB::table('roles')->get();
        $provinces = DB::table('province')->get();
        return view('backend.admin.employees.edit', compact('employee', 'provinces', 'roles', 'user'));
    }
