                            ...
                            <div class="col-md-12">
                                <div class="page-header">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        {{ Form::text('name_activity', null, ['class' => 'form-control my-border margin-search', 'placeholder' => 'Nombre']) }}
                                    </div>
                                    <div class="form-group">
                                        {{ Form::text('description_activity', null, ['class' => 'form-control my-border margin-search' , 'placeholder' => 'Detalle']) }}
                                    </div>
                                    <div class="form-group">
